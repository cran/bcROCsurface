#' @title A sub-data from Pre-PLCO Phase II Dataset
#' @name EOC
#' @docType data
#'
#' @description A subset of the Pre-PLCO Phase II Dataset from the SPORE/Early Detection Network/Prostate, Lung, Colon, and Ovarian Cancer Ovarian Validation Study. This data deals with epithelial ovarian cancer (EOC).
#'
#' @usage EOC
#'
